  ...
  <div class="col-12 col-lg-8">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div>
          <h5 class="mb-0">Edit Rental Record</h5>
          <small class="text-muted">Update monthly rental income</small>
        </div>
        ...
        <form method="POST" action="{{ route('assets.rentals.update', $rental) }}" class="row g-2">
          ...
          <div class="col-md-3">
            ...
            <input type="number" name="year" class="form-control @error('year') is-invalid @enderror"
                   value="{{ old('year', $rental->year) }}" min="2000" max="2100" required>
          ...
          <div class="col-md-3">
            ...
            <input type="number" name="month" class="form-control @error('month') is-invalid @enderror"
                   value="{{ old('month', $rental->month) }}" min="1" max="12" required>
          ...
          <div class="col-md-3">
            ...
            <input type="date" name="agreement_start_date" class="form-control @error('agreement_start_date') is-invalid @enderror"
                   value="{{ old('agreement_start_date', optional($rental->agreement_start_date)->format('Y-m-d')) }}">
          ...
          <div class="col-md-4">
            ...
            <select name="rent_type" class="form-select @error('rent_type') is-invalid @enderror">
              ...
              @foreach(['Airbnb','Long-term','Other'] as $t)
                <option value="{{ $t }}" @selected(old('rent_type', $rental->rent_type) === $t)>{{ $t }}</option>
              @endforeach
            </select>
